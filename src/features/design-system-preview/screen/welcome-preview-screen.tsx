  ...
  return (
    <Page>
      ...
      <p className="mb-9 max-w-[62ch] text-[14px] leading-[1.6] text-ink-2">
        The design system is a single piece of paper on the desk. Use the rail on the left to walk
        through the parts. Each entry mirrors a specimen in the source{' '}
        <span className="font-mono">Medcord Design System</span> repo and is composed from the React
        primitives in <span className="font-mono">@shared/ui</span>.
      </p>
      ...
      <Sheet padding="md" className="max-w-[680px]">
        <Stack gap="md">
          ...
          <RecordNumber>MRN 10458291 · ENC-2026-04-29-1184 · 64 M · DOB 1962-03-14</RecordNumber>
          <DictatedText>
