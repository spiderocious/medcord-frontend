...
/**
 * Imperative API. Ported from
 * `ohlify/backend/packages/ui/src/modals/drawer-service.ts`.
 *
 * Mount `<ModalHost />` + `<ToastHost />` once at the app root and call
 * `DrawerService.toast(...) / .showFeedbackModal(...)` from anywhere.
 */
