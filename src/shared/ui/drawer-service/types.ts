...
/**
 * Drawer-service types — ported from
 * `ohlify/backend/packages/ui/src/modals/types.ts` and adapted to the
 * surgical-paper aesthetic. The public shape is intentionally identical so
 * the imperative API muscle-memory carries over.
 */
